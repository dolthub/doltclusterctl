...
def go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:IgdUtTRvUDC6eiJBqU6vh7bHFNAEBjQ8S+qJ7zVhDOs=",
        version = "v1.18.43",
    )
    go_repository(
        ...
        sum = "h1:dgbKq1tamtboYAKSXWbqL0lKO9rmEzEhbZFh9JQW/Bg=",
        version = "v1.13.41",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:g+qlObJH4Kn4n21g69DjspU0hKTjWtq7naZ9OLCv0ew=",
        version = "v1.3.43",
    )
    go_repository(
        ...
        sum = "h1:Qw8H7V55d2P1d/a9+cLgAcdez4GtP6l30KQAeYqx9vY=",
        version = "v1.20.0",
    )
    go_repository(
        ...
        sum = "h1:hGoFtG9m82xWTFwLLwQxMWQlwkoTUxwvKEGs9htAqEA=",
        version = "v1.18.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:vuGK1vHNP9zx0PfOrtPumbwR2af0ATQ1Z2H6p75AgRQ=",
        version = "v1.15.0",
    )
    go_repository(
        ...
        sum = "h1:8lKOidPkmSmfUtiTgtdXWgaKItCZ/g75/jEk6Ql6GsA=",
        version = "v1.17.1",
    )
    go_repository(
        ...
        sum = "h1:pyvfUqkNLMipdKNAtu7OVbRxUrR2BMaKccIPpk/Hkak=",
        version = "v1.23.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:f/ztie/ZLBXZLB69kjRlgvIJ/xREA7ZvpC0J1/+Ersk=",
        version = "v0.0.0-20230906235100-ae4cac8b496c",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:+9C/TgFfcCmZBV7Fjb3kQCGlkpFrhtvFDgbdQHB9RaA=",
        version = "v0.0.0-20240722112252-5a72de7e7962",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:qAHKkHlGuB31epYq/nE7CJsdVVn8Nn88vBRuRhNWC9g=",
        version = "v2.6.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:pkly7gKIeYv3olPAeNajNpLjeJrmTPYCoZWaV+2VfvE=",
        version = "v2.23.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:eqQALBtPCth8+ulTs6lcPK7ytV5rZSSHJzQHZph4O7U=",
        version = "v0.3.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:g4y4eu0qa+SCeKESLpESgMmVFBebL0BDa6f777OIWrg=",
        version = "v0.24.0",
    )
    go_repository(
